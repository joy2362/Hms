...
if (isset($_GET['action']) && $_GET['action']=="logout") {
  ...
  $query = $db->conn->prepare("select * from blog where blog_id='$id'");
  $query->execute();
      ...
      <div class="container">
		...
		<section class="ftco-section">
          ...
          <div class="col-lg-8 ftco-animate">
            <h2 class="mb-3">#<?php echo $result['blog_id']?>. <?php echo $result['blog_tittle']?></h2>
             <img src="<?php echo $result['picture']?>" alt="" class="img-fluid">
