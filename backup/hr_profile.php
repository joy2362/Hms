...
class HrProfile {
    ...
    public function getProfile($id,$table){
      try {
                            ...
                            <div class="col-xl-8">
                                ...
                                <div class="user-data m-b-40">
                                    <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-account-calendar"></i>Stuff survice</h3>
                                         <button class="au-btn au-btn-icon au-btn--green float-right mr-2">
                                        <i class="zmdi zmdi-plus"></i>add stuff</button>
                                    ...
                                    <div class="table-responsive table-data">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php
                                                    while ($info=$employee->fetch(PDO::FETCH_ASSOC)) {
                                                        $id=$info['user_id'];
                                                        $type=$info['user_type'];
                                                        $table=$type."_info";
                                                        $userInfo=$profile->getProfile($id,$table);
                                                ?>
                                                <tr>
                                                    <td>
